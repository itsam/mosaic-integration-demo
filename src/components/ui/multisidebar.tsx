...
const SIDEBAR_WIDTH_MOBILE_LEFT = "18rem";
const SIDEBAR_WIDTH_MOBILE_RIGHT = "4rem";
const RIGHT_SIDEBAR_WIDTH = "21rem";
  ...
  (
            ...
            style={
              {
                "--sidebar-width":
                  side === "left"
                    ? SIDEBAR_WIDTH_MOBILE_LEFT
                    : SIDEBAR_WIDTH_MOBILE_RIGHT,
              } as React.CSSProperties
            }
            side={side}
          >
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "h-svh-itsam fixed inset-y-0 top-16 z-10 hidden w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex",
            side === "left"
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        // "relative top-16 flex min-h-svh flex-1 flex-col bg-background",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "no-scrollbar flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-auto",
        className,
      )}
      {...props}
    />
